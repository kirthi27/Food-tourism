    ...
    <div className="col-lg-6 mt-5">
        <div className="row mt-4">
            <div className="col-lg-6">
                <img src={require("./Food/Food1.jpeg")} style={{height:'13rem', width:'100%'}} className="img-fluid" alt="..." />
            </div>
            <div className="col-lg-6">
                <img src={require("./Food/Food2.jpg")} className="img-fluid" alt="..."  style={{height:'13rem', width:'100%'}}/>
            </div>
        </div>
        <div className="row mt-4">
            <div className="col-lg-6">
                <img src={require("./Food/Food3.jpeg")} className="img-fluid" alt="..." style={{height:'13rem', width:'100%'}}/>
            </div>
            <div className="col-lg-6">
                <img src={require("./Food/Food4.jpg")} className="img-fluid" alt="..." style={{height:'13rem', width:'100%'}}/>
            </div>
        </div>
</div>
      
       <h4 style={{textAlign:'center'}}>TAMILNADU</h4>
       <h5 style={{textAlign:'center'}}>FAMOUS AND LOCAL FOODS</h5>
      
        <div className='row mt-5'>
        <div className='col-lg-6'>         
        <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',
        height:'32rem',marginRight:'15px',width:'90%'}}>
     <Card.Body>
        <Card.Title style={{textAlign:'center'}}>Food of Chennai</Card.Title>
         <Card.Text style={{textIndent:'4rem',marginTop:'1rem',textAlign:'justify'}}>
        <p>Chennai's local cuisine consists of traditional South
...
Pongal, Kesari, Payasam and much more        </p></Card.Text>
    ...
    height:'32rem',marginRight:'15px',width:'90%'}}>
     <Card.Body>
                    <Card.Title style={{textAlign:'center'}}>Food of Rameshwaram</Card.Title>
         <Card.Text style={{textIndent:'4rem',marginTop:'2rem',textAlign:'justify'}}>
        <p>Rameswaram offers delicious and elaborate South-
...
Besides the regular biryani and parotta, plenty of soup
...
<div className="row mt-5">
            ...
            style={{boxShadow:'5px 5px 10px black',height:'28rem',marginRight:'15px',width:'90%'}}>
                <Card.Body>
            ...
            <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',height:'28rem',width:'90%'}}>
                <Card.Body>
                    <Card.Title style={{textAlign:'center'}}>Food of Ooty</Card.Title>
                    <Card.Text style={{textIndent:'4rem',marginTop:'2rem',textAlign:'justify'}}>
...
<div className="row mt-5">
  <div className="col-lg-6">
      <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',height:'26rem',width:'90%'}}>
      <Card.Body>
    ...
    <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',height:'26rem',width:'90'}}>
    <Card.Body>
      <Card.Title style={{textAlign:'center'}}>Food Of Kumbakonam </Card.Title>
      
         <Card.Text style={{textIndent:'4rem',marginTop:'2rem',textAlign:'justify'}}>

        <p>Vegetarian food rules the roost here with pre- dominantly Tamil cuisines on offer.
           One can get authentic South Indian cuisines which will tickle your taste buds. 
   ...
   <div className="row mt-5">
       <div className="col-lg-6 ">
       <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',height:'32rem',marginRight:'15px',width:'90%'}}>
       <Card.Body>
    ...
    <div className="col-lg-6 ">
     <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',height:'31rem',marginRight:'15px',width:'90%'}}>
     <Card.Body>
      <Card.Title style={{textAlign:'center'}}>Food Of Yercaud </Card.Title>
  ...
  <div className="row mt-5">
      <div className="col-lg-6 ">
      <Card className='rounded-5 p-3' style={{boxShadow:'5px 5px 10px black',height:'18rem',marginRight:'15px',width:'90%'}}>
      <Card.Body>
